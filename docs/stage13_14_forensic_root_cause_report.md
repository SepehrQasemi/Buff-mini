...
## Executive Summary
- git_head: `f291ee61659fa2c6cdc13f28917f8700ea2bb8a2`
- runtime_seconds: `94.911`
- final_conclusion: `BUG_FOUND_AND_FIXED`
- raw_evidence: `docs/stage13_14_forensic_root_cause_raw.json`

## Baseline (Before)
- `{'master_final_verdict': 'NO_EDGE', 'stage13_combined': {'invalid_pct': 100.0, 'zero_trade_pct': 25.0, 'walkforward_executed_true_pct': 100.0, 'mc_trigger_rate': 75.0, 'best_exp_lcb': 49.78228993550447}, 'stage14_nested': {'folds_evaluated': 16, 'consistency': 0.0625, 'classification': 'NO_EDGE'}}`
...
| 10 | Zero-trade Causes Attribution | FAIL | ZERO_TRADE_UNATTRIBUTED | `docs/stage13_14_forensic_root_cause_raw.json#checks[10]` |
...
- `{'before': {'master_final_verdict': 'NO_EDGE', 'stage13_combined': {'invalid_pct': 100.0, 'zero_trade_pct': 25.0, 'walkforward_executed_true_pct': 100.0, 'mc_trigger_rate': 75.0, 'best_exp_lcb': 49.78228993550447}, 'stage14_nested': {'folds_evaluated': 16, 'consistency': 0.0625, 'classification': 'NO_EDGE'}}, 'after': {'stage13_combined': {'zero_trade_pct': 37.5, 'invalid_pct': 75.0, 'walkforward_executed_true_pct': 100.0, 'mc_trigger_rate': 62.5, 'tpm': 6.7716170853108, 'trade_count': 81.25}, 'stage14_nested': {'stage': '14.3', 'folds_evaluated': 16, 'consistency': 0.0625, 'classification': 'NO_EDGE'}}}`

## Warnings
- 1 checks failed

## Limitations
- zero-trade attribution still has unclassified buckets
