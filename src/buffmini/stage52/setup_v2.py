...
_FAMILY_GEOMETRY: dict[str, dict[str, Any]] = {
    ...
    "failed_breakout_reversal": {
        "entry_logic": "enter_on_failed_breakout_reversal",
        "stop_logic": "beyond_failed_breakout_extreme",
        "target_logic": "snapback_to_value",
        "hold_logic": "hold_until_reversal_fades_or_target_hits",
        "stop_pct": 0.0050,
        "first_target_pct": 0.0100,
        "stretch_target_pct": 0.0150,
        "hold_bars": 6,
    },
    "exhaustion_mean_reversion": {
        "entry_logic": "enter_on_exhaustion_reversion",
        "stop_logic": "beyond_exhaustion_extreme",
        "target_logic": "mean_reversion_to_mid",
        "hold_logic": "hold_until_mean_reversion_completes",
        "stop_pct": 0.0045,
        "first_target_pct": 0.0090,
        "stretch_target_pct": 0.0130,
        "hold_bars": 6,
    },
    "funding_oi_imbalance_reversion": {
        "entry_logic": "enter_on_crowding_reversion",
        "stop_logic": "crowding_acceleration_break",
        "target_logic": "imbalance_normalization",
        "hold_logic": "hold_until_crowding_normalizes",
        "stop_pct": 0.0055,
        "first_target_pct": 0.0105,
        "stretch_target_pct": 0.0155,
        "hold_bars": 10,
    },
    "volatility_regime_transition": {
        "entry_logic": "enter_on_regime_transition_break",
        "stop_logic": "inside_regime_recompression",
        "target_logic": "expansion_follow_through",
        "hold_logic": "hold_while_regime_transition_persists",
        "stop_pct": 0.0065,
        "first_target_pct": 0.0125,
        "stretch_target_pct": 0.0190,
        "hold_bars": 12,
    },
    "multi_tf_disagreement_repair": {
        "entry_logic": "enter_on_bias_realignment",
        "stop_logic": "repaired_bias_break",
        "target_logic": "alignment_extension",
        "hold_logic": "hold_while_alignment_remains_intact",
        "stop_pct": 0.0060,
        "first_target_pct": 0.0110,
        "stretch_target_pct": 0.0165,
        "hold_bars": 10,
    },
}
